...
<script language="javascript" type="text/javascript">
  function uploadImg()
  {
    ...
    var showload = window.parent.document.getElementById("op1");
...
<!--  
  ...
  if(flag=='ok')
  {
    var userPhoto= window.parent.document.getElementById("course_jklx");
    userPhoto.value=filename;
    window.parent.document.getElementById("op1").style.display="none";
    document.getElementById("upTip").innerHTML="上传成功！";
    window.parent.document.getElementById("userImg1").innerHTML=filename;
  }
  else if(flag=='no')
  {
    window.parent.document.getElementById("op1").style.display="none";
