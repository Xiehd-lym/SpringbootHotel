...
$(document).ready(function(){
	 $("#editBtn").bind('click',function(){
		...
		$("#info").attr('action','updatezixun.action').submit();
...
<form id="info" name="info" action="updatezixun.action" method="post">   
  ...
  <tr> 
   ...
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
      <tr>
          <td width="150" align="right" style="padding-right:5px"> ID：</td>
          <td width="*">
          	<input readonly name="id" value="${ zixun.id }">
          </td>
        </tr> 
        <tr>
          <td width="150" align="right" style="padding-right:5px"> 标题：</td>
          <td width="*">
          	<input name="title" value="${ zixun.title }">
          </td>
        </tr> 
        ...
        <tr>
          ...
          <td>
          	<textarea name="content"  id="noticeContent" style="width:500px;height:150px">${ zixun.content }</textarea>
          </td>
        </tr> 
     </table>
     </td>
