...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">酒店类型管理&gt;&gt;酒店类型查询</span>
</div>
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <c:if test="${goodsTypes==null ||  fn:length(goodsTypes)==0}">
   <tr>
     <td height="60" colspan="10" align="center"><b>&lt;不存在酒店类型信息&gt;</b></td>
   </tr>
   </c:if>
