...
$(document).ready(function(){
	 var manager_sex = "${admin.manager_sex}";
...
<input type="hidden" name="manager_id" value="${admin.manager_id}"/>
   ...
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
        ...
        <tr>
          ...
          <td>
             <input type="radio" name="manager_sex" id="sex1" value="1"/>男&nbsp;&nbsp;
             <input type="radio" name="manager_sex" id="sex2" value="2"/>女
          </td>
        </tr>     
        <tr>
          <td align="right" style="padding-right:5px">邮箱：</td>
          <td>
          	<input type="text" id="manager_mail" name="manager_mail" value="${admin.manager_mail}"/>
          </td>
          <td align="right" style="padding-right:5px">电话：</td>
          <td>
          	<input type="text" id="manager_phone" name="manager_phone" value="${admin.manager_phone}"/>
          </td>
        </tr> 
     </table>
     </td>
