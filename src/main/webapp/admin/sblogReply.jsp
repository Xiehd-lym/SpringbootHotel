...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">留言信息管理&gt;&gt;回复留言信息</span>
</div>
...
<input type="hidden" id="user_id" name="user_id" value="${admin.manager_id}" /> 
