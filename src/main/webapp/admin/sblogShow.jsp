...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">用户留言管理&gt;&gt;用户留言查询</span>
</div>
  ...
  <tr>
    ...
    <td width="" align="right">
      ...
      <input type="text" id="nick_name" name="nick_name" 
      		value="${paramsSblog.nick_name}" class="inputstyle" style="width:150px;"/>&nbsp;
            留言内容：
      <input type="text" id="sblog_content" name="sblog_content" 
      		value="${paramsSblog.sblog_content}" class="inputstyle" style="width:150px;"/>&nbsp;
