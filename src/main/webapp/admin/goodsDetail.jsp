     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
        <tr>
          <td width="40%" align="center">
          	<img src="../images/datas/${goods.goods_pic}" width="300" /> 
          </td>
          <td width="60%" style="line-height:22px;">
          	酒店号：${goods.goods_no}
          	<br/>酒店名称：${goods.goods_name}
          	<br/>酒店类型：${goods.goods_type_name}
          	<br/>发行商：${goods.goods_publisher}
            <br/>酒店原价：￥${goods.goods_price} 元
            <br/>当前折扣：${goods.goods_discount} 折
          </td>
        </tr> 
        <tr>
          <td colspan="2" style="padding:10px;line-height:22px">
