...
function CheckSend(orders_id)
{
	if(confirm('确认发货吗!?'))
    {
       window.location.href="Admin_sendOrders.action?orders_id="+orders_id;
    }
}
</script>
</head>
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">酒店订单管理&gt;&gt;酒店订单查询</span>
</div>
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="" align="right">
            订单编号：
      <input type="text" id="orders_no" name="orders_no" value="${paramsOrders.orders_no}" class="inputstyle" Style="width:100px;"/>&nbsp;      
            用户姓名：
      <input type="text" id="real_name" name="real_name" value="${paramsOrders.real_name}" class="inputstyle" Style="width:100px;"/>&nbsp;
            订单状态：
      <select id="orders_flag" name="orders_flag" class="selectstyle" style="width:100px;">
      	...
      	<option value="3" ${paramsOrders.orders_flag==3?'selected':''}>已收货</option>
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="list0" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">
       ...
       <a href="javascript:CheckSend('${orders.orders_id}')">发货</a>
       </c:if>
     </td>
   </tr> 
   </c:forEach>
   ...
   <c:if test="${orderss==null || fn:length(orderss)==0}">
   <tr>
     <td height="60" colspan="11" align="center"><b>&lt;不存在酒店订单信息&gt;</b></td>
   </tr>
   </c:if>
</table>
