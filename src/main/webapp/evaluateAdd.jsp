...
<div id="middle">
	 ...
	 <div id="product_info">
			...
			<div style="margin-top:5px">
				 ...
				 <input type="hidden" name="nick_name" id="nick_name" value="${userFront.nick_name}"/>
				 <table class="ptable" style="margin-bottom:5px;">
			        <tr>
			          <td width="15%" align="right" style="padding-right:5px">评价额度：</td>
			          <td width="*">
			          <select id="evaluate_level" name="evaluate_level" class="selectstyle" style="width:100px;">
				      	<option value="1">差评</option>
				      	<option value="2">一般</option>
				      	<option value="3">比较满意</option>
				      	<option value="4" selected>好评</option>
				      </select>
			          </td>
			        </tr>
			        <tr>
